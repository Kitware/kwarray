...
Notes:
    ...
    sphinx-apidoc --private -f -o ~/code/kwarray/docs/source ~/code/kwarray/kwarray --separate
    make html
    ...
    Also:
        ...
        Then go to
            ...
            https://gitlab.kitware.com/computer-vision/kwarray/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/kwarray/versions/
"""
#
...
man_pages = [
    (master_doc, 'kwarray', 'kwarray Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'kwarray', 'kwarray Documentation',
     author, 'kwarray', 'One line description of project.',
     'Miscellaneous'),
]
